...
# con bash
curl --request GET \
--url "http://localhost:8080/newProject/mvn_selenium_junit5_cucumber?model=gpt-5.3-codex&projectName=ta_copilot&goupId=com.nttdata&javaVersion=25&seleniumVersion=4.41.0&junitVersion=5.13.4&junitPlatformVersion=1.13.4&cucumberVersion=7.27.2&webdrivermanagerVersion=6.3.3&surefireVersion=3.2.5&compilerPluginVersion=3.13.0" \
--header "Accept: */*" \
